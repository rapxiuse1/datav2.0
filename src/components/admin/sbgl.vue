      ...
      <el-container>
            ...
            >
              <el-submenu index="1">
                ...
                <el-menu-item-group>
                  ...
                  <el-menu-item index="1-2" @click="go(1)"
                    >设备分类管理</el-menu-item
                  >
                </el-menu-item-group>
              </el-submenu>
        ...
        <el-main class="main">
          ...
          <div class="modal1-2" v-show="modal2Show">
            ...
            <div class="row">
              设备能力id:<el-input
                v-model="capablities_id_arrays"
                placeholder="请输入设备能力id"
              ></el-input>
            </div>
            <el-button
              size="large"
          ...
          <div class="modal1-3" v-show="modal3Show">
            <img
              ...
              @click="close(4)"
            />
            <p>设备名称:{{ this.sbMessage.device_name }}</p>
            <p>设备状态:{{ this.sbMessage.device_status_desc }}</p>
            <p>设备id:{{ this.sbMessage.id }}</p>
            <p>设备类型:{{ this.sbMessage.device_type_name }}</p>
            <p>设备出厂编号:{{ this.sbMessage.serial_number }}</p>
          </div>
          <div class="modal1-2" v-show="modal4Show">
            ...
            <div class="row" style="margin-top:0">
              名称:<el-input
                v-model="device_name1"
                placeholder="请输入设备名称"
              ></el-input>
            </div>
            <div class="row">
              设备出厂编号:<el-input
                v-model="serial_number1"
                placeholder="请输入设备出厂编号"
              ></el-input>
            </div>
            <div class="row">
            ...
            <div class="row">
              设备能力id:<el-input
                v-model="capablities_id_arrays1"
                placeholder="请输入设备能力id"
              ></el-input>
            </div>
            <el-button
...
export default {
  data() {
    return {
      ...
      serial_number: "",
      device_type_id: "",
      capablities_id_arrays: "",
      device_name1: "",
      serial_number1: "",
      device_type_id1: "",
      capablities_id_arrays1: "",
      sbMessage: "",
      sbid: "",
      modalShow: false,
      modal1Show: false,
  ...
  methods: {
    ...
    initData() {
      let code = "api/v1/device?page=1&per_page=10";
      this.$axios({
        url: code,
        method: "get",
        params: {}
      }).then(res => {
        this.tableData = res.data.data.device_list;
    ...
    handleClick(index, row) {
      let code = "api/v1/device/detail?id=" + row.id;
      this.$axios({
        url: code,
        method: "get",
        params: {}
    ...
    modify(index, row) {
      ...
      this.$axios({
        ...
        this.sbMessage = res.data.data;
        this.device_name1 = this.sbMessage.device_name;
        this.serial_number1 = this.sbMessage.serial_number;
        this.device_type_id1 = this.sbMessage.device_type_id;
        this.capablities_id_arrays1 =
          res.data.data.device_capablities_list[0].capablities_id;
    ...
    confirmAdd() {
      ...
      let device_type_id = this.device_type_id;
      let capablities_id_arrays = this.capablities_id_arrays;
      let code = "api/v1/device/add";
      ps.append("device_name", device_name);
      ps.append("serial_number", serial_number);
      ps.append("device_type_id", device_type_id);
      ps.append("capablities_id_arrays", capablities_id_arrays);
      this.$axios({
        url: code,
        method: "post",
        data: ps,
    ...
    confirmAdd1() {
      let ps = new FormData();
      let device_name = this.device_name1;
      let serial_number = this.serial_number1;
      let device_type_id = this.device_type_id1;
      let capablities_id_arrays = this.capablities_id_arrays1;
      let id = this.sbid;
      let code = "api/v1/device/edit=" + id;
      ps.append("device_name", device_name);
      ps.append("serial_number", serial_number);
      ps.append("device_type_id", device_type_id);
      ps.append("capablities_id_arrays", capablities_id_arrays);
    ...
    handleCurrentChange(val) {
      let code = "api/v1/device?page=" + val + "&per_page=10";
      this.$axios({
        url: code,
        method: "get",
        params: {}
    ...
    prePage(val) {
      let code = "api/v1/device?page=" + val - 1 + "&per_page=10";
      this.$axios({
        url: code,
        method: "get",
        params: {}
