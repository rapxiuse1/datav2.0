              ...
              <el-submenu index="2">
                ...
                <el-menu-item-group>
                  <el-menu-item index="2-1" @click="go(3)"
                    >规则管理</el-menu-item
                  >
                  <el-menu-item index="2-2">规则分类管理</el-menu-item>
                </el-menu-item-group>
              </el-submenu>
        ...
        <el-main class="main">
          ...
          <div class="modal1-3" v-show="modal3Show">
            <img
              ...
              @click="close(4)"
            />
            <p>规则分类名称:{{ this.sbMessage.rule_type_name }}</p>
            <p>规则id:{{ this.sbMessage.id }}</p>
            <p>创建时间:{{ this.sbMessage.create_time }}</p>
            <p>更新时间:{{ this.sbMessage.update_time }}</p>
          </div>
...
export default {
  ...
  methods: {
    ...
    initData() {
      let code = "api/v1/rule_type?page=1&per_page=10";
      this.$axios({
        url: code,
        method: "get",
        params: {}
      }).then(res => {
        this.tableData = res.data.data.rule_type_list;
    ...
    handleCurrentChange(val) {
      let code = "api/v1/rule_type?page=" + val + "&per_page=10";
      this.$axios({
        url: code,
        method: "get",
        params: {}
    ...
    prePage(val) {
      let code = "api/v1/rule_type?page=" + val - 1 + "&per_page=10";
      this.$axios({
        url: code,
        method: "get",
        params: {}
